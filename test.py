...
def main():
    ...
    warmup = pad_sequences(warmup, maxlen=lm.max_sequence_length)
    ...
    for review in reviews:
        ...
        for sentence in review:
            if sentence.strip():
                ...
                context_buffer.extend(lm.preprocess([sentence])[0])
                sequences_padded = pad_sequences([context_buffer], maxlen=lm.max_sequence_length)
